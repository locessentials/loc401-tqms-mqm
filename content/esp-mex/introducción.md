...
Antes de adentrarse en las definiciones y marcos oficiales del curso, tómate un momento para reflexionar sobre qué significa para ti la calidad en traducción y localización.

Crea un **póster personal de calidad**, es decir, una sola imagen que capture tu definición de calidad en traducción y localización. Tu póster debe:

- Expresar tu definición mediante **frases clave de no más de 10 palabras cada una**
